...
\documentclass[openright,titlepage,oneside,fleqn,
	headinclude,10pt,a4paper,footinclude,makeidx]{scrbook}
...
\lstdefinelanguage{NetLogo}{
    ...
    morekeywords=[3]{turtles, count, with, out-link-neighbors, random-float, exp, not, n-of, color, any?, size, sqrt, my-links, one-of, both-ends, of},
...
% Capitoli
\include{2-chapters/0-introduzione}
\include{2-chapters/1-capitolo}
\include{2-chapters/2-capitolo}
\include{2-chapters/3-capitolo}
\include{2-chapters/4-capitolo}
\include{2-chapters/5-conclusioni}

%---------------------APPENDIX---------------------------------
\appendix
\include{3-appendix/a-appendice}
%\include{3-appendix/b-acronimi}
%--------------------------------------------------------------

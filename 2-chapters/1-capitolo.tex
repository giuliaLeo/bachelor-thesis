...
\item R, che può essere interpretato sia come \emph{guariti} (recovered) che come \emph{rimossi} (removed)
\end{itemize}
...
\end{cases} 
\]
laddove $\beta$ e $\gamma$, entrambe costanti $> 0$, sono rispettivamente il rate d'infezione e di guarigione/rimozione. Al sistema soprastante vengono aggiunte anche le opportune condizioni iniziali: $S(0) = S_0 > 0$, $I(0) = I_0 > 0$, $R(0) = 0$. 